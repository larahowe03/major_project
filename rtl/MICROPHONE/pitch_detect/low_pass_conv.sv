...
module low_pass_conv #(
    ...
    // ---------------------------------------------------------
    // 3. Filter coefficients (41-tap FIR impulse response)
    // ---------------------------------------------------------
    ...
    // ---------------------------------------------------------
    // 5. Multiply stage (registered for DSP inference)
    // ---------------------------------------------------------
    ...
    // ---------------------------------------------------------
    // 6. First addition stage (partial sums)
    // ---------------------------------------------------------
    ...
    // ---------------------------------------------------------
    // 8. Output stage (fixed-point truncation and valid delay)
    // ---------------------------------------------------------
    logic x_valid_q1, x_valid_q2;
