...
# File: wheelsmove.tcl
# Generated on: Thu Oct 16 11:53:40 2025
...
if {[is_project_open]} {
	if {[string compare $quartus(project) "wheelsmove"]} {
		puts "Project wheelsmove is not open"
		set make_assignments 0
	}
} else {
	# Only open if not already open
	if {[project_exists wheelsmove]} {
		project_open -revision wheelsmove wheelsmove
	} else {
		project_new -revision wheelsmove wheelsmove
	}
...
if {$make_assignments} {
	...
	set_global_assignment -name PROJECT_CREATION_TIME_DATE "10:21:00  OCTOBER 16, 2025"
