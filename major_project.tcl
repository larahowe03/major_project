...
# File: major_project.tcl
# Generated on: Thu Oct 16 10:44:34 2025
...
if {[is_project_open]} {
	if {[string compare $quartus(project) "major_project"]} {
		puts "Project major_project is not open"
		set make_assignments 0
	}
} else {
	# Only open if not already open
	if {[project_exists major_project]} {
		project_open -revision major_project major_project
	} else {
		project_new -revision major_project major_project
	}
...
if {$make_assignments} {
	...
	set_global_assignment -name PROJECT_CREATION_TIME_DATE "09:08:30  OCTOBER 16, 2025"
	...
	set_global_assignment -name SYSTEMVERILOG_FILE rtl/BOARD_INTERFACE/synchroniser.sv
	set_global_assignment -name SYSTEMVERILOG_FILE rtl/BOARD_INTERFACE/debounce_keys.sv
	set_global_assignment -name SYSTEMVERILOG_FILE rtl/BOARD_INTERFACE/debounce.sv
	set_global_assignment -name SYSTEMVERILOG_FILE "rtl/PROXIMITY_HC-SR04/refresher250ms.sv"
	set_global_assignment -name SYSTEMVERILOG_FILE "rtl/PROXIMITY_HC-SR04/proximity_sensor.sv"
